...
Чтобы применить лицензию Apache к вашей работе, приложите следующее
стандартное уведомление с полями, заключенными в квадратные скобки "[]"
замените вашей собственной идентификационной информацией. (Скобки не включать!)
Текст должен быть заключен в соответствующий синтаксис комментария для
формата файла. Мы также рекомендуем, чтобы название файла или класса и
описание назначения должны быть включены на той же "печатной странице",
что и уведомление об авторских правах, для упрощения идентификация в
сторонних архивах.

Авторское право [2022] [Zeleza]
...
Если это не требуется применимым законодательством или не согласовано в
письменной форме, программное обеспечение распространяется по лицензии
